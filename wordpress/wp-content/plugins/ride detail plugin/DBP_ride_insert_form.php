...
<form id="regForm" name="form" method="post" enctype="multipart/form-data">
          ...
          <select name="suitcases" class="form-control" id="suitcases" onchange="vehicle()">
            ...
            <div id="vehicalTable">
              ...
              <table class="table table-dark">
                  ...
                  <tbody>
                  <tr>
                    <td><img style="width: 50px" src="http://localhost/wordpressnew/wordpress/wp-content/uploads/2019/11/car.png"></td>
                    <td>Car</td>
                    <td>20000</td>
                    <td>4</td>
                    <td>3</td>
                    <td><input type="radio" name="selectVehical" value="car"></td>
                  </tr>

                  <tr>
                    <td><img style="width: 50px" src="http://localhost/wordpressnew/wordpress/wp-content/uploads/2019/11/van.png"></td>
                    <td>Van</td>
                    <td>35000</td>
                    <td>8</td>
                    <td>10</td>
                    <td><input type="radio" name="selectVehical" value="van"></td>
                  </tr>

                  <tr>
                    <td><img style="width: 50px" src="http://localhost/wordpressnew/wordpress/wp-content/uploads/2019/11/bus.png"></td>
                    <td>Bus</td>
                    <td>45000</td>
                    <td>30</td>
                    <td>20</td>
                    <td><input type="radio" name="selectVehical" value="bus"></td>
                  </tr>
...
<?php
function DBP_insert_ride_data(){


    $DBP_firstname=$_POST['firstname'];
    $DBP_lastname=$_POST['lastname'];
    $DBP_email=$_POST['email'];
    $DBP_phone=$_POST['phone'];
    $DBP_dob=$_POST['dob'];
    $DBP_passportId=$_POST['passportId'];
    $DBP_comments=$_POST['comments'];
    $DBP_pickupdate=$_POST['pickupdate'];
    $DBP_pickuptime=$_POST['pickuptime'];
    $DBP_pickUpLocation=$_POST['pickUpLocation'];
    $DBP_dropOffLocation=$_POST['dropOffLocation'];
    $DBP_payment=$_POST['payment'];
    $DBP_imagefile=$_POST['imagefile'];
    ...
    if(isset($_POST['submit'])){
      global $wpdb;
      $table_name= $wpdb->prefix.'ride_details';
      $path_array = wp_upload_dir();
        $wpdb->insert($table_name,
                    array(
                        'firstname'=>$DBP_firstname,
                        'lastname'=>$DBP_lastname,
                        'email'=>$DBP_email,
                        'phone'=>$DBP_phone,
                        'dob'=>$DBP_dob,
                        'passportId'=>$DBP_passportId,
                        'comments'=>$DBP_comments,
                        'pickupdate'=>$DBP_pickupdate,
                        'pickuptime'=>$DBP_pickuptime,
                        'pickUpLocation'=>$DBP_pickUpLocation,
                        'dropOffLocation'=>$DBP_dropOffLocation,
                        'payment'=>$DBP_payment,
